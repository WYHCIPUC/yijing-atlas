...
const modeLoaders = {
  almanac: () => import('./almanac-page.js?v=41').then((module) => module.renderAlmanacPage),
  divination: () => import('./modes/divination-mode.js?v=41').then((module) => module.renderDivinationMode),
  learning: () => import('./modes/learning-mode.js?v=41').then((module) => module.renderLearningMode),
  quiz: () => import('./modes/quiz-mode.js?v=41').then((module) => module.renderQuizMode),
  review: () => import('./modes/review-mode.js?v=41').then((module) => module.renderReviewMode),
};
